...
#include "../ExecFramework/AlignmentUtils.h"
...
namespace specnets
{
    ...
    const unsigned short Spectrum::BIN_VERSION = 2;
    ...
    vector<float> Spectrum::IMMONIUM_ION_MASSES = vector<float> {
        // Existing Ion from all sources
        30.03438, // Glycine (G) - IonSource
        44.05003, // Alanine (A) - IonSource
        55.05423, // IV-NH3,II-CH2-NH3,IL-CH2-NH3 (I,V,L) - SpectiCal
        56.04948, // IT-H2O,IQ-CO-NH3,IK-C2H4-NH3,IR-C2H4N2-NH3 (T,Q,R,K) - SpectiCal
        60.04439, // IS (S) - SpectiCal
        60.05562, // IR-C4H7N (R) - SpectiCal
        61.01065, // IM-C2H2-NH3 (M) - SpectiCal
        69.03349, // IV+CO-NH3-CH2,IL[Acetyl]-C3H6-NH3 (V,L) - SpectiCal
        69.06988, // II-NH3,IL-NH3 (I,L) - SpectiCal
        70.02874, // ID-H2O,IN-NH3,b{S}-H2O,IS+CO-H2O,a{GG}-NH3 (S,N,D) [Fragment] - SpectiCal
        70.06513, // IP,IR-CH5N3,IR-CH2N2-NH3 (P,R) - SpectiCal
        71.06848, // IP+i,IR-CH5N3+i,IR-CH2N2-NH3+i (P,R) - SpectiCal
        72.08078, // IV,II-CH2,IL-CH2 (I,V,L) - SpectiCal
        73.08413, // IV+i,II-CH2+i,IL-CH2+i (I,V,L) - SpectiCal
        74.06004, // IT (T) - SpectiCal
        76.0221, // Cysteine (C) - IonSource
        // 81.03349, // b{P}-NH3,y{P}-H2O-NH3,IR+H2O-N3H7-NH3 (R) [Fragment] - SpectiCal
        // 83.06037, // IQ-H2O,IR-CH6N2,a{AG}-H2O,IR-CH3N-NH3 (Q,R) [Fragment] - SpectiCal
        84.04439, // IQ-NH3,IE-H2O,b{T}-H2O,IT+CO-H2O,a{AG}-NH3 (E,Q,T) [Fragment] - SpectiCal
        84.08078, // IK-NH3 (K) - SpectiCal
        85.01065, // IM[Oxidation]-H2O-NH3,IM[Acetyl]-C2H2-H2O-NH3 (M) - SpectiCal
        // 85.02841, // IE-NH3,b{T}-NH3,IT+CO-NH3,y{T}-H2O-NH3 (E,T) [Fragment] - SpectiCal
        // 85.04774, // IQ-NH3+i,IE-H2O+i,b{T}-H2O+i,IT+CO-H2O+i,a{AG}-NH3+i (E,Q,T) [Fragment] - SpectiCal
        85.08413, // IK-NH3+i (K) - SpectiCal
        86.06004, // IL[Acetyl]-C3H6 (L) - SpectiCal
        86.09643, // II,IL (I,L) - SpectiCal
        87.05529, // IN,a{GG},IS+CO+NH3-H2O (S,N) [Fragment] - SpectiCal
        87.09978, // II+i,IL+i (I,L) - SpectiCal
        88.0393, // ID,b{S},IS+CO,y{S}-H2O (S,D) [Fragment] - SpectiCal
        91.05423, // IF-CH3N,IY-CO-NH3 (Y,F) - SpectiCal
        93.04472, // IH-NH3 (H) - SpectiCal
        95.06037, // IR-NH3-NH3 (R) - SpectiCal
        // 98.06004, // b{P},y{P}-H2O,a{AA}-NH3,IR+H2O-N3H7 (R) [Fragment] - SpectiCal
        // 99.04406, // y{P}-NH3,IR+H2O+H2O-N3H7-NH3 (R) [Fragment] - SpectiCal
        100.04741, // y{P}-NH3+i,IR+H2O+H2O-N3H7-NH3+i (R) [Fragment] - SpectiCal
        100.08692, // IR-CH3N (R) - SpectiCal
        101.07094, // IQ,a{AG},IT+CO+NH3-H2O (Q,T) [Fragment] - SpectiCal
        101.10732, // IK (K) - SpectiCal
        102.05495, // IE,b{T},IT+CO,y{T}-H2O (E,T) [Fragment] - SpectiCal
        102.07429, // IQ+i,a{AG}+i,IT+CO+NH3-H2O+i (Q,T) [Fragment] - SpectiCal
        103.05423, // IF-NH3 (F) - SpectiCal
        // 103.0583, // IE+i,b{T}+i,IT+CO+i,y{T}-H2O+i (E,T) [Fragment] - SpectiCal
        104.05285, // IM (M) - SpectiCal
        105.0562, // IM+i (M) - SpectiCal
        105.06585, // C3H9N2O2,IS+CO+NH3 (S) - SpectiCal
        106.04853, // CH6N4O2,IH+CO-H2O-NH+i (H) - SpectiCal
        107.04914, // IY-CH3N (Y) - SpectiCal
        110.07127, // IH (H) - SpectiCal
        110.09643, // C7H12N,IL[Acetyl]-H2O (L) - SpectiCal
        // 111.05529, // b{Q}-H2O,IQ+CO-H2O,b{AG}-H2O (Q) [Fragment] - SpectiCal
        111.07462, // IH+i (H) - SpectiCal
        111.08044, // IL[Acetyl]-NH3 (L) - SpectiCal
        // 111.09167, // b{K}-H2O,IK+CO-H2O,a{GV}-H2O (K) [Fragment] - SpectiCal
        112.07569, // b{K}-NH3,IK+CO-NH3,a{GV}-NH3,y{K}-H2O-NH3 (K) [Fragment] - SpectiCal
        112.08379, // IL[Acetyl]-NH3+i (L) - SpectiCal
        112.08692, // IR-NH3 (R) - SpectiCal
        113.05971, // IK+CO+H2O-NH3-NH3 (K) - SpectiCal
        113.09027, // IR-NH3+i (R) - SpectiCal
        // 114.09134, // b{I},b{L},y{I}-H2O,y{L}-H2O,IL[Acetyl]-CH2 (L) [Fragment] - SpectiCal
        // 116.01646, // a{CG}-NH3,IC[Carbamidomethyl]-NH3 (C) [Fragment] - SpectiCal
        // 116.0706, // y{P},IR+H2O+H2O-N3H7 (R) [Fragment] - SpectiCal
        117.07395, // y{P}+i,IR+H2O+H2O-N3H7+i (R) [Fragment] - SpectiCal
        118.06513, // IY-H2O (Y) - SpectiCal
        119.04914, // IY-NH3 (Y) - SpectiCal
        119.0815, // IT+CO+NH3,C4H11N2O2 (T) - SpectiCal
        120.0483, // Methionine Oxidized methionine (M) - IonSource
        120.08078, // IF (F) - SpectiCal
        120.08485, // IT+CO+NH3+i (T) - SpectiCal
        121.08413, // IF+i (F) - SpectiCal
        123.05529, // IH+CO-NH,a{AN}-H2O-NH3,a{GQ}-H2O-NH3,a{AGG}-H2O-NH3 (H) [Fragment] - SpectiCal
        128.10699, // IL[Acetyl] (L) - SpectiCal
        129.06585, // b{Q},IQ+CO,b{AG},y{Q}-H2O,y{AG}-H2O,a{SS}-H2O (Q) [Fragment] - SpectiCal
        129.10224, // b{K},IK+CO,a{GV},y{K}-H2O (K) [Fragment] - SpectiCal
        129.11347, // IR (R) - SpectiCal
        130.06513, // IW-CH3N,b{F}-H2O (W) [Fragment] - SpectiCal
        130.08626, // y{K}-NH3,IK+CO+H2O-NH3 (K) [Fragment] - SpectiCal
        130.10559, // b{K}+i,IK+CO+i,a{GV}+i,y{K}-H2O+i (K) [Fragment] - SpectiCal
        // 131.06848, // IW-CH3N+i,b{F}-H2O+i (W) [Fragment] - SpectiCal
        // 131.08961, // y{K}-NH3+i,IK+CO+H2O-NH3+i (K) [Fragment] - SpectiCal
        132.08078, // IW-CHN,a{PP}-H2O-NH3 (W) [Fragment] - SpectiCal
        // 133.04301, // a{CG},IC[Carbamidomethyl] (C) [Fragment] - SpectiCal
        134.0276, // Cysteine Carboxymethylated (C) - IonSource
        136.07569, // IY,b{AV}-H2O-NH3,b{GI}-H2O-NH3,b{GL}-H2O-NH3,a{PT}-H2O-NH3 (Y) [Fragment] - SpectiCal
        // 137.07904, // IY+i,b{AV}-H2O-NH3+i,b{GI}-H2O-NH3+i,b{GL}-H2O-NH3+i,a{PT}-H2O-NH3+i (Y) [Fragment] - SpectiCal
        138.06619, // b{H},IH+CO,y{H}-H2O (H) [Fragment] - SpectiCal
        // 139.0502, // y{H}-NH3,IH+CO+H2O-NH3,a{NS}-H2O-NH3,a{GGS}-H2O-NH3 (H) [Fragment] - SpectiCal
        // 140.08184, // b{R}-NH3,IR+CO-NH3,a{AN}-H2O,a{GQ}-H2O,a{AGG}-H2O,y{R}-H2O-NH3,IK+CO+H2ON2-H2O-NH3 (R,K) [Fragment] - SpectiCal
        // 142.06513, // IW-NH3,a{FG}-H2O-NH3 (W) [Fragment] - SpectiCal
        // 146.06004, // b{Y}-H2O,IY+CO-H2O (Y) [Fragment] - SpectiCal
        // 146.06341, // IM[Acetyl],a{DG}+i,b{GS}+i,y{GS}-H2O+i (M) [Fragment] - SpectiCal
        147.0772, // Cysteine Acrylamide adduct (C) - IonSource
        // 147.1128, // y{K},IK+CO+H2O (K) [Fragment] - SpectiCal
        // 148.11615, // y{K}+i,IK+CO+H2O+i (K) [Fragment] - SpectiCal
        // 156.07675, // y{H},IH+CO+H2O,a{NS}-H2O,a{GGS}-H2O (H) [Fragment] - SpectiCal
        // 157.10839, // b{R},IR+CO,y{R}-H2O,IK+CO+H2ON2-H2O (R,K) [Fragment] - SpectiCal
        // 158.0924, // a{AN},a{GQ},a{AGG},y{R}-NH3,IR+CO+H2O-NH3,IK+CO+H2ON2-NH3 (R,K) [Fragment] - SpectiCal
        // 158.11174, // b{R}+i,IR+CO+i,y{R}-H2O+i,IK+CO+H2ON2-H2O+i (R,K) [Fragment] - SpectiCal
        159.09167, // IW,a{FG}-H2O (W) [Fragment] - SpectiCal
        // 160.09502, // IW+i,a{FG}-H2O+i (W) [Fragment] - SpectiCal
        // 163.08659, // IY+CO+NH3-H2O,a{PQ}-H2O-NH3,a{AGP}-H2O-NH3 (Y) [Fragment] - SpectiCal
        // 164.0706, // b{Y},IY+CO,y{Y}-H2O,a{EP}-H2O-NH3,b{PT}-H2O-NH3 (Y) [Fragment] - SpectiCal
        // 169.07602, // b{W}-H2O,IW+CO-H2O (W) [Fragment] - SpectiCal
        170.06004, // b{W}-NH3,IW+CO-NH3,y{W}-H2O-NH3,b{FG}-H2O-NH3 (W) [Fragment] - SpectiCal
        171.06339 // b{W}-NH3+i,IW+CO-NH3+i,y{W}-H2O-NH3+i,b{FG}-H2O-NH3+i (W) [Fragment] - SpectiCal
        // 175.11895, // y{R},IR+CO+H2O,IK+CO+H2ON2 (R,K) [Fragment] - SpectiCal
        // 176.1223, // y{R}+i,IR+CO+H2O+i,IK+CO+H2ON2+i (R,K) [Fragment] - SpectiCal
        // 181.09715, // IY+CO+NH3,a{EP}-H2O,a{PQ}-NH3,b{PT}-H2O,a{AGP}-NH3,a{DK}-H2O-NH3,b{KS}-H2O-NH3,a{AAT}-H2O-NH3,a{GSV}-H2O-NH3 (Y) [Fragment] - SpectiCal
        // 182.1005, // IY+CO+NH3+i,a{EP}-H2O+i,a{PQ}-NH3+i,b{PT}-H2O+i,a{AGP}-NH3+i,a{DK}-H2O-NH3+i,b{KS}-H2O-NH3+i,a{AAT}-H2O-NH3+i,a{GSV}-H2O-NH3+i (Y) [Fragment] - SpectiCal
        // 187.08659, // b{W},IW+CO,y{W}-H2O,b{FG}-H2O (W) [Fragment] - SpectiCal
        // 188.08994, // b{W}+i,IW+CO+i,y{W}-H2O+i,b{FG}-H2O+i (W) [Fragment] - SpectiCal

        // Missing immonium ions from Mascot
        // 41, // V - Mascot
        // 44, // I - Mascot
        // 44, // L - Mascot
        // 59, // R - Mascot
    ...
    unordered_map<string, vector<float>> Spectrum::TAG_MASSES = unordered_map<string, vector<float>> {
        { "TMT 2-plex",   { 126.127726, 127.131081, 225.155833+1.007276035 } },
        { "TMT 6-plex",   { 126.127726, 127.124761, 128.134436, 129.131471, 130.141145,
                            131.138180, 229.162932+1.007276035} },
        { "TMT 10-plex",  { 126.127726, 127.124761, 127.131081, 128.128116, 128.134436,
                            129.131471, 129.137790, 130.134825, 130.141145, 131.138180, 229.162932+1.007276035 } },
        { "TMT 11-plex",  { 126.127726, 127.124761, 127.131081, 128.128116, 128.134436,
                            129.131471, 129.137790, 130.134825, 130.141145, 131.138180,
                            131.144499, 229.162932+1.007276035  } },
        { "TMT 16-plex",  { 126.127726, 127.124761, 127.131081, 128.128116, 128.134436,
                            129.131471, 129.137790, 130.134825, 130.141145, 131.138180,
                            131.144499, 132.141535, 132.147855, 133.144890, 133.151210,
                            134.148245, 229.162932+1.007276035, 304.207146+1.007276035 } },
        { "iTRAQ 4-plex", { 114.1112, 115.1083, 116.1116, 117.1150, 145.1069 } },
        { "iTRAQ 8-plex", { 113.10783, 114.111228, 115.108263, 116.111618, 117.114973,
                            118.112008, 119.115363, 121.122072, 145.1069 } }
    };
    ...
    Spectrum::FragType Spectrum::parseActivation(const string& activString)
    {
        ...
        {
            WARN_MSG("Found unknown fragmentation ID \'" << activString << "\', assuming no fragmentation given.");
            return FragType_NONE;
        }
    }
    ...
    string Spectrum::activationToString(Spectrum::FragType& activ)
    {
        ...
        {
            ERROR_MSG("Found unknown fragmentation or no fragmentation type \'" << activ << "\', returning empty string");
            return "";
        }
    }
    ...
    Spectrum::MassAnalyzerType Spectrum::parseMassAnalyzer(const string& analyzerString)
    {
        ...
        else if (myCopy.find("ion trap") != string::npos || myCopy.find("itms") != string::npos)
        {
    ...
    void Spectrum::initialize()
    {
        ...
        env_intensity = 0.0;
        precursor_scan = 0;
        isolation_window_start = 0.0;
        isolation_window_end = 0.0;
        nativeID = "";
        precursorNativeID = "";
    }
    ...
    Spectrum &Spectrum::copyNP(const Spectrum &other)
    {
        ...
        env_intensity = other.env_intensity;
        precursor_scan = other.precursor_scan;
        isolation_window_start = other.isolation_window_start;
        isolation_window_end = other.isolation_window_end;
        nativeID = other.nativeID;
        precursorNativeID = other.precursorNativeID;
        return (*this);
    }
   ...
   */
    ...
    int Spectrum::removePeaksByMz(vector<float>& mzes, float tol, bool isSorted, float ppm)
    {
        if (mzes.size() == 0 || this->size() == 0) {
            return 0;
        }

        if (!isSorted) {
            sort(mzes.begin(), mzes.end());
        }

        size_t peakIdx = 0;
        size_t ionIdx = 0;

        list<int> peakToRemoves;
        for (float ionMass : mzes) {
            double adjTol = ppm > 0 ? ppmToTol(ionMass, ppm) : tol;
            if (ionMass > this->peakList[this->size() - 1][0]) {
                break;
            }
            while (
                peakIdx < this->size()
                && this->peakList[peakIdx][0] < ionMass
                && abs(this->peakList[peakIdx][0] - ionMass) > adjTol
            ) {
                peakIdx++;
            }
            while (
                ...
                peakToRemoves.emplace_back(peakIdx);
                peakIdx++;
            }
        }

        this->removePeaks(peakToRemoves);

        return peakToRemoves.size();
    }
    // -------------------------------------------------------------------------
    ...
    // Scaling peak intensities so that the most intense peak is maxOfMostIntensePeak
    void Spectrum::normalizeMostIntense(int maxOfMostIntensePeak)
    {
        unsigned int maxIntensity = 0;
        for (unsigned int i = 0; i < peakList.size(); i++) {
            if (peakList[i][1] > maxIntensity) {
                maxIntensity = peakList[i][1];
            }
        }
        for (unsigned int i = 0; i < peakList.size(); i++) {
            peakList[i][1] = maxOfMostIntensePeak * peakList[i][1] / maxIntensity;
        }
    }

    void Spectrum::norm2_normalize_and_mz_binning(float newNorm2, int inversedBinSize)
    {
        float factor = 0;
        for (unsigned int i = 0; i < peakList.size(); ++i) {
            peakList[i][0] = int(peakList[i][0] * inversedBinSize);
            factor += peakList[i][1] * peakList[i][1];
        }
        factor = sqrt(factor) / newNorm2;
        for (unsigned int i = 0; i < peakList.size(); ++i) {
                           ...
                           vector<pair<unsigned int, unsigned int> > *matchedPeaksIdx)
    {
     ...
     return cosine; */
        cerr << "ERROR: Calling disabled method Spectrum::cosine()\n";
        exit(-1);
    }
   ...
   * @return
   */
    int Spectrum::rankFilterPeaks(int maxRank, float windowRadius) {
        int numPeaks = this->size();
        set<int> peakIndicesToRemove;
        int lowerBoundI = 0;
        int upperBoundI = 0;
        list<int> peakIdxsToRemove;

        // Sliding window of (intensity, peak index)
        set<pair<float, int>> topPeaksWindow;
        for (int i = 0; i < numPeaks; i++) {
            TwoValues<float> peak = this->peakList[i];
            while (
                (lowerBoundI < i)
                && (peak[0] - this->peakList[lowerBoundI][0] > windowRadius)
            ) {
                set<pair<float, int>>::iterator peakWindowSearch = topPeaksWindow.find({
                    this->peakList[lowerBoundI][1], lowerBoundI
                });
                if (peakWindowSearch != topPeaksWindow.end()) {
                    topPeaksWindow.erase(peakWindowSearch);
                }
                lowerBoundI++;
            }

            while (
                (upperBoundI < numPeaks)
                && (this->peakList[upperBoundI][0] - peak[0] <= windowRadius)
            ) {
                topPeaksWindow.emplace(this->peakList[upperBoundI][1], upperBoundI);
                upperBoundI++;
            }

            bool found = false;
            int j = 0;
            for (reverse_iterator<set<pair<float, int>>::iterator> iter = topPeaksWindow.rbegin()
                ; j < maxRank && iter != topPeaksWindow.rend()
                ; iter++) {
                if (i == iter->second) {
                    found = true;
                }
            ...
            if (!found) {
                peakIdxsToRemove.emplace_back(i);
            }
        }
        this->removePeaks(peakIdxsToRemove);
        return peakIdxsToRemove.size();
    }
    ...
    {
        cerr << "Warning: this function does not look for isotope peak properly as it only considers 3.1Da/z. Use it with caution!" << endl;
        if (size() == 0)
        {
            return 0;
        }
    ...
    int Spectrum::removePrecursors(
            const double tol,
            const double precursorFilterWindow,
            const float parentMass,
            const int parentCharge,
            const bool removeDethiomethylOxidation,
            const bool removeDehydratedPhospho,
            const double ppm) {
        const double DETHIOMETHYL_MASS = -48.003371;
        const double OXIDATION_MASS = 15.994915;
        const double PHOSPHO_MASS = 79.966331;

        int peakIdx = 0;

        vector<pair<PrecursorPeak, double>> potentialPrecursorPeaksSorted;
        unordered_map<PrecursorPeak, bool, PrecursorPeakHash> potentialPrecursorPeaksSeen;

        int z = parentCharge;
        if (z < 0) {
            z = this->parentCharge;
        }
        float M = parentMass - AAJumps::massHion;
        if (M < 0) {
            M = this->parentMZ * z - (z * AAJumps::massHion);
        }
        float parentMz = (M + (z * AAJumps::massHion)) / z;

        if (this->size() == 0 || z <= 0 || M <= 0) {
            return 0;
        }

        vector<pair<string, double>> ls {{ "M-H2O", AAJumps::massH2O }, { "M-NH3", AAJumps::massNH3 }, { "M", 0 }};
        if (removeDethiomethylOxidation) {
            ls.emplace_back("M-DethiomethylOxidation", OXIDATION_MASS - DETHIOMETHYL_MASS);
        }
        if (removeDehydratedPhospho) {
            ls.emplace_back("M-DehydratedPhospho", AAJumps::massH2O + PHOSPHO_MASS);
        }
        for (pair<string, double> &l : ls) {
            for (int n = 0; n < 15; n++) {
                if (z != 0) {
                    potentialPrecursorPeaksSorted.push_back({
                        { z, l.first, n },
                        (M + z * AAJumps::massHion - l.second + n * (AAJumps::massC13 - AAJumps::massC)) / z
                    });
                }
                potentialPrecursorPeaksSeen[{z, l.first, n}] = false;
            }
        }

        greater<double> greaterDouble = std::greater<double>();
        sort(potentialPrecursorPeaksSorted.begin(), potentialPrecursorPeaksSorted.end(),
            [greaterDouble](const pair<PrecursorPeak, double> &a, const pair<PrecursorPeak, double> &b) -> bool {
                return greaterDouble(b.second, a.second); 
            }
        );

        int precIdx = 0;
        vector<pair<TwoValues<float>, int>> accPeaksWithIdx;
        accPeaksWithIdx.reserve(this->size());
        bool peakMatches = true;
        int prevIsotope = 0;
        bool prevIsotopeSeen = true;

        while (peakIdx < this->peakList.size() && precIdx < potentialPrecursorPeaksSorted.size()) {
            TwoValues<float> spectrumPeak = this->peakList[peakIdx];
            pair<PrecursorPeak, double> precursorPeak = potentialPrecursorPeaksSorted[precIdx];
            double adjTol = ppm > 0 ? ppmToTol(precursorPeak.second, ppm) : tol;

            prevIsotopeSeen = true;

            if (abs(spectrumPeak[0] - parentMz) < precursorFilterWindow) {
                // If the peak is in the window, increment peak and - do not continue
                // as we want to ensure we mark that this isotope has been seen
                peakMatches = false;
            } else if (precursorPeak.first.amountC13 > 1) {
                // Check that the peak isotope is not -1, 0 or 1
                prevIsotope = precursorPeak.first.amountC13 - 1;
                PrecursorPeak prevPeak {precursorPeak.first.charge, precursorPeak.first.type, prevIsotope};
                prevIsotopeSeen = potentialPrecursorPeaksSeen[prevPeak];
            }

            if (prevIsotopeSeen && abs(spectrumPeak[0] - precursorPeak.second) < adjTol) {
                // Mark the isotope as seen
                potentialPrecursorPeaksSeen[precursorPeak.first] = true;
                peakMatches = false;
                precIdx++;
            } else {
                if (spectrumPeak[0] < precursorPeak.second) {
                    if (peakMatches) {
                        accPeaksWithIdx.emplace_back(spectrumPeak, peakIdx);
                    }
                    peakMatches = true;
                    peakIdx++;
                } else {
        ...
        while (peakIdx < this->peakList.size() && (this->peakList[peakIdx][0] - precursorFilterWindow) <= parentMz) {
            if (abs(this->peakList[peakIdx][0] - parentMz) > precursorFilterWindow) {
                accPeaksWithIdx.emplace_back( this->peakList[peakIdx], peakIdx);
            }
            peakIdx++;
        }
        while (peakIdx < this->peakList.size()) {
            accPeaksWithIdx.emplace_back(this->peakList[peakIdx], peakIdx);
            peakIdx++;
        }

        vector<pair<TwoValues<float>, int>> accPeaksFiltWithIdx;
        accPeaksFiltWithIdx.reserve(accPeaksWithIdx.size());
        for (const auto &[p, idx] : accPeaksWithIdx) {
            peakMatches = true;
            if (peakMatches) {
                accPeaksFiltWithIdx.emplace_back(p, idx);
            }
        }

        vector<pair<TwoValues<float>, int>> sortedPeaksWithIdx = accPeaksFiltWithIdx;
        sort(sortedPeaksWithIdx.begin(), sortedPeaksWithIdx.end(),
            [greaterDouble](const pair<TwoValues<float>, int> &a, const pair<TwoValues<float>, int> &b) {
                return greaterDouble(b.first[1], a.first[1]);
            }
        );

        list<int> peaksToRemove;
        int removeIdx = 0;
        for (const auto& [peak, idx] : accPeaksFiltWithIdx) {
            while (removeIdx < idx) {
                peaksToRemove.emplace_back(removeIdx);
                removeIdx++;
            }
            removeIdx++;
        }
        while (removeIdx < this->size()) {
            peaksToRemove.emplace_back(removeIdx++);
        }
        this->removePeaks(peaksToRemove);

        return peaksToRemove.size();
    }

    int Spectrum::removeTopUnannotatedEnvelopes(
        const PeakAnnotationResult& peakAnnotationResult,
        const AnnotationFragmentIons& theoreticalAnnotation,
        const int numTopUnannotatedEnvelopesToRemove,
        const double tol,
        const double ppm
    ) {
        set<size_t> annotatedIdxs;
        for (size_t i = 0; i < peakAnnotationResult.size(); i++) {
            annotatedIdxs.emplace(peakAnnotationResult.getPeakIndexAt(i));
        }

        int maxCharge = theoreticalAnnotation.maxIonCharge > 0 ? theoreticalAnnotation.maxIonCharge : 3;

        // Find top annotated envelopes
        // Calculate isotopic envelopes
        int numPeaks = this->size();
        vector<float> highestEnvelopeIntensity;
        vector<vector<int>> highestIntensityEnvelope;
        vector<int> highestEnvelopeMonoisotopic;
        for (int i = 0; i < numPeaks; i++) {
            highestEnvelopeIntensity.emplace_back(0.0);
            highestIntensityEnvelope.emplace_back();
            highestEnvelopeMonoisotopic.emplace_back(-1);
        }
        for (int peakIdx = 0; peakIdx < numPeaks; peakIdx++) {
            if (annotatedIdxs.find(peakIdx) != annotatedIdxs.end()) {
                continue;
            }
            TwoValues<float> peak = this->peakList[peakIdx];
            for (int z = 1; z <= maxCharge; z++) {
                float currIsotopeMz = peak[0];
                vector<int> currEnvelope; // vector of peak indices
                float currEnvelopeTotalIntensity = 0.0;
                bool isotopeFound = true;
                int otherPeakIdx = peakIdx; // potential isotope peak in spectrum
                while (isotopeFound) {
                    isotopeFound = false;
                    double adjTol = ppm > 0 ? ppmToTol(currIsotopeMz, ppm) : tol;
                    // go to the first peak in currIsotopeMz tolerance range, iterate
                    while (
                        (otherPeakIdx < numPeaks)
                        && (this->peakList[otherPeakIdx][0] < currIsotopeMz - adjTol)
                    ) {
                        otherPeakIdx++;
                    }
                    while (
                        ...
                        if (annotatedIdxs.find(otherPeakIdx) == annotatedIdxs.end()) {
                            currEnvelope.emplace_back(otherPeakIdx);
                            currEnvelopeTotalIntensity += this->peakList[otherPeakIdx][1];
                            isotopeFound = true;
                        }
                        otherPeakIdx++;
                    }
                    if (isotopeFound) {
                        currIsotopeMz += AAJumps::massHion / z;
                    }
                }

                // See if this charge has the best envelope so far
                if (highestEnvelopeIntensity[peakIdx] < currEnvelopeTotalIntensity) {
                    highestEnvelopeIntensity[peakIdx] = currEnvelopeTotalIntensity;
                    highestIntensityEnvelope[peakIdx] = currEnvelope;
                }
            }
            // Check if this is new best envelope for isotopic peak
            for (const int &envPeakIdx : highestIntensityEnvelope[peakIdx]) {
                if (highestEnvelopeIntensity[envPeakIdx] <= highestEnvelopeIntensity[peakIdx]) {
                    highestEnvelopeIntensity[envPeakIdx] = highestEnvelopeIntensity[peakIdx];
                    highestEnvelopeMonoisotopic[envPeakIdx] = peakIdx;
                }
            }
        }

        // Go through unannotated envelopes by decreasing intensity. Unsorted but use heap
        // instead of sorting (min heap is used here)
        priority_queue<pair<float, int>, vector<pair<float, int>>, greater<pair<float, int>>> h;
        if (numTopUnannotatedEnvelopesToRemove > 0) {
            int hSize = 0;
            for (int peakI = 0; peakI < highestEnvelopeIntensity.size(); peakI++) {
                float envIntensity = highestEnvelopeIntensity[peakI];
                pair<float, int> k { envIntensity, highestEnvelopeMonoisotopic[peakI] };
                if (
                    (peakI == highestEnvelopeMonoisotopic[peakI])
                    && ((hSize < numTopUnannotatedEnvelopesToRemove) || (envIntensity > h.top().first))
                ) {
                    h.push(k);
                    hSize++;
                    if (hSize > numTopUnannotatedEnvelopesToRemove) {
                        h.pop();
                    }
                }
            }
        }
        set<int> highestUnannotatedMonoIndexes;
        while (!h.empty()) {
            pair<float, int> z = h.top();
            highestUnannotatedMonoIndexes.emplace(z.second);
            h.pop();
        }
        list<int> peaksToRemove;
        for (int peakIdx = 0; peakIdx < highestEnvelopeMonoisotopic.size(); peakIdx++) {
            int monoPeakIdx = highestEnvelopeMonoisotopic[peakIdx];
            if (highestUnannotatedMonoIndexes.find(monoPeakIdx) != highestUnannotatedMonoIndexes.end()) {
                if (peakIdx != -1) {
                    peaksToRemove.emplace_back(peakIdx);
                }
            }
        }
    ...
    Spectrum Spectrum::extractAnnotated(const PeakAnnotationResult& peakAnnotationResult) {
        Spectrum newSpec = *this; 
        vector<size_t> peakIdxs;
        for (size_t i = 0; i < peakAnnotationResult.size(); i++) {
            peakIdxs.emplace_back(peakAnnotationResult.getPeakIndexAt(i));
        }
        sort(peakIdxs.begin(), peakIdxs.end());
        list<int> peaksToRemove;
        int i = 0;
        for (const unsigned long& peakIdx : peakIdxs) {
            while (i < peakIdx) {
                peaksToRemove.emplace_back(i);
                i++;
            }
            i++;
        }
        while (i < newSpec.size()) {
            peaksToRemove.emplace_back(i);
            i++;
        }
        newSpec.removePeaks(peaksToRemove);
        return newSpec;
    }

    Spectrum Spectrum::extractUnannotated(const PeakAnnotationResult& peakAnnotationResult) {
        Spectrum newSpec = *this; 
        vector<size_t> peakIdxs;
        for (size_t i = 0; i < peakAnnotationResult.size(); i++) {
            peakIdxs.emplace_back(peakAnnotationResult.getPeakIndexAt(i));
    ...
    int Spectrum::removeIsobaricTagPeaks(float tolerance, string isobaricTagType, float ppm) {
        if (
            isobaricTagType != "N/A"
            && (isobaricTagType.size() == 0 || Spectrum::TAG_MASSES.find(isobaricTagType) == Spectrum::TAG_MASSES.end())
        ) {
            // Default to TMT-16
            isobaricTagType = "TMT 16-plex";
        }

        // Then apply isobaric tag filters, get both the peaks until the isobaric filters are finished, and that peak index
        list<int> peaksToRemove;
        if (
            isobaricTagType.length() > 0 && isobaricTagType != "N/A"
        ) {
            vector<float>& isobaricTagPeaks = Spectrum::TAG_MASSES[isobaricTagType];
            return this->removePeaksByMz(isobaricTagPeaks, tolerance, true, ppm);
        }

        return 0;
    }

    int Spectrum::removeImmoniumIonPeaks(float tolerance, float ppm) {
        return this->removePeaksByMz(Spectrum::IMMONIUM_ION_MASSES, tolerance, true, ppm);
    }
    ...
    {
        //output << ":0.0.0\n";
        output << parentMass << " " << parentCharge << " " << specID << endl;
        for (unsigned int i = 0; i < peakList.size(); i++)
   ...
   */
    ...
    bool Spectrum::saveToBinaryStream(FILE* fp)
    {
        ...
        vector<string> fNativeID(1);
        fNativeID[0] = nativeID;
        if (!writeStringsToBinaryStream(fp, fNativeID))
        {
            ERROR_MSG("Failed to save nativeID");
            return false;
        }
        ...
        //Writing Precursor kl
        count = fwrite(&(precursor_kl), sizeof(float), 1, fp);
        if (count == 0)
        {
            ERROR_MSG("Failed to save precursor kl");
            return false;
        }

        //Writing precursor scan
        count = fwrite(&(precursor_scan), sizeof(int), 1, fp);
        if (count == 0)
        {
            ERROR_MSG("Failed to save precursor scan");
            return false;
        }

        //Writing envelope intensity
        count = fwrite(&(env_intensity), sizeof(float), 1, fp);
        if (count == 0)
        {
            ERROR_MSG("Failed to save envelope intensity");
            return false;
        }

        //Writing envelope intensity
        count = fwrite(&(isolation_window_start), sizeof(float), 1, fp);
        if (count == 0)
        {
            ERROR_MSG("Failed to save isolation window start");
            return false;
        }

        //Writing envelope intensity
        count = fwrite(&(isolation_window_end), sizeof(float), 1, fp);
        if (count == 0)
        {
            ERROR_MSG("Failed to save isolation window end");
            return false;
        }
                                        ...
                                        map<string, unsigned short>& versions)
    {
        ...
        else if (fragT == (short)FragType_NONE)
        {
            msFragType = FragType_NONE;
        }
        else
        ...
        //if (version >= 3 && subVersion >= 5) {
        //v3.4 also has nativeID
        if (version >= 2 && subVersion >= 4) {
            vector<string> fNativeID;
            if ((!readStringsFromBinaryStream(fp, fNativeID)) || fNativeID.size() == 0)
            {
                ERROR_MSG("Failed to read nativeID");
                return false;
            }
            nativeID = fNativeID[0];
        }
        ...
        // NOTE This caused an error when loading pklbin file for IndexSearch (shifted field)
        if (version >= 2 && subVersion >= 3) {
            count = fread(&precursor_kl, sizeof(float), 1, fp);
            if (count == 0) {
                ERROR_MSG("Failed to read precursor kl");
                return false;
            }
            count = fread(&precursor_scan, sizeof(int), 1, fp);
            if (count == 0)
            {
                ERROR_MSG("Failed to read precursor scan");
                return false;
            }
            count = fread(&env_intensity, sizeof(float), 1, fp);
            if (count == 0)
            {
                ERROR_MSG("Failed to read envelope intensity");
                return false;
            }
            count = fread(&isolation_window_start, sizeof(float), 1, fp);
            if (count == 0)
            {
                ERROR_MSG("Failed to read isolation window start");
                return false;
            }
            count = fread(&isolation_window_end, sizeof(float), 1, fp);
            if (count == 0)
            {
                ERROR_MSG("Failed to read isolation window end");
                return false;
            }
        }
        return true;
	...
	// -------------------------------------------------------------------------------------
	// A bug was found in this function. The socre1 and score2 were not initialized to zero.
	// This bug was fixed in the scoreMatch3 function.
	// -------------------------------------------------------------------------------------
    float Spectrum::scoreMatch2(const Spectrum &spectrum_comparison,
                                float & peakTol,
                                unsigned int & matchPeaks,
                                float & score1,
                                float & score2,
                                ...
                                bool preprocess) const
    {
        ...
        const Spectrum & spec1 = *this;
        const Spectrum & spec2 = spectrum_comparison;
...
//        }
        ...
        if (projectedCosine) {
            ...
            for (int i = (int)peakMatches.size() - 1; i >= 0; i--)
            {
                if (peakUsed1[peakMatches[i].i] == 0 and peakUsed2[peakMatches[i].j] == 0)
                {
                    peakUsed1[peakMatches[i].i] = 1;
                    peakUsed2[peakMatches[i].j] = 1;
                    score1 += (spec1[peakMatches[i].i][1]/sqrt(matchedPeaksNorm1)) * spec2[peakMatches[i].j][1];
                    score2 += spec1[peakMatches[i].i][1] * (spec2[peakMatches[i].j][1]/sqrt(matchedPeaksNorm2));
                }
            }
        }
	...
	float Spectrum::scoreMatch3(const Spectrum &spectrum_comparison, 
								float peakTol, 
								unsigned int & matchPeaks, 
								float & score1, 
								float & score2, 
	...
	{
        vector<int> idxMatched1_zero, idxMatched1_other;
        idxMatched1_zero.reserve(1500); idxMatched1_zero.resize(0);
        idxMatched1_other.reserve(1500); idxMatched1_other.resize(0);
        vector<int> idxMatched2_zero, idxMatched2_other;
        idxMatched2_zero.reserve(1500); idxMatched2_zero.resize(0);
        idxMatched2_other.reserve(1500); idxMatched2_other.resize(0);
		...
		if (projectedCosine) {
            score1 = cosine / sqrt(matchedPeaksNorm1);
            score2 = cosine / sqrt(matchedPeaksNorm2);
        }
    ...
    void Spectrum::output_json(json & j) {

        vector<pair<float, float> > peaks(peakList.size());

        for (int i = 0; i < peakList.size(); i++) {
            peaks[i] = make_pair(peakList[i][0],peakList[i][1]);
        }
        j["nativeid"] = nativeID;
        j["ms_level"] = msLevel;
        if (msLevel >= 2) {
            j["precursor"]["charge"] = parentCharge;
            j["precursor"]["mz"] = parentMZ;
        }
        j["peaks"] = peaks;
    ...
    // @csjgwang
    /**
	 * Test whether the current spectrum is the same as another one
	 * @param another spectrum
	 * @return true if they're equal, false otherwise
	 * Note: the comparison is based on the following fields (obtained from saveToBinaryStream())
	 * in the following order
		0 specID: unsigned long long
		1 scan: int
		2 parentCharge: short
		7 fileName: int + actual bytes
		8 parentMass: float
		13 numPeaks = peakList.size(): int
		14 peakList: peakList: sizeof(TwoValues<float>) * numPeaks, each entry is a TwoValues type
	 */
//	bool Spectrum::is_equal(Spectrum* another) {
//		// 0
//		if (specID != another->specID) {
//			cout << "specID not equal" << endl;
//			return false;
//		}
//
//		// 1
//		if (scan != another->scan) {
//			cout << "scan not equal" << endl;
//			return false;
//		}
//
//		// 2 parentCharge: short
//		if (parentCharge != another->parentCharge) {
//			cout << "parentCharge not equal" << endl;
//			return false;
//		}
//
//		// 7
//		if (fileName != another->fileName) {
//			cout << "fileName not equal" << endl;
//			return false;
//		}
//
//		// 8
//		if (fabs(this->parentMass - another->parentMass) > 1e-4) {
//			cout << "parentMass not equal" << endl;
//			return false;
//		}
//
//		// 13
//		if (peakList.size() != another->peakList.size()) {
//			cout << "peakList.size() not equal" << endl;
//			return false;
//		}
//
//		// 14 peakList
//		int num_peaks = peakList.size();
//// #if INTENSITY_COMPRESSION == 0
//		if (global_intensity_compression == false) {
//			for (int i = 0; i < num_peaks; i ++) {
//				if ((fabs(this->peakList[i][0] - another->peakList[i][0]) > 1e-4)
//					||
//				   (fabs(this->peakList[i][1] - another->peakList[i][1]) > 1e-4)) {
//					cout << "peakList content not equal, idx = " << i << endl;
//					return false;
//				}
//			}
//		}
...
//				if ((fabs(this->peakList[i][0] - another->peakList[i][0]) > 1e-4)
//					||
//					((int)(255*peakList[i][1]) != (int)(255*another->peakList[i][1]))) {
//					cout << "peakList content not equal, idx = " << i << endl;
//					cout << "peakList[i][1] = " << peakList[i][1] << endl;
//					cout << "another->peakList[i][1] = " << another->peakList[i][1] << endl;
//					this->output_ms2(cout);
//					return false;
//				}
//			}
//		}
...
//	}
	...
	* @param len: size of the buffer, obtained from size_in_bytes()
	* @return buffer: store the serialized bytes
	* serialization order
	0 specID: unsigned long long
	1 scan: int
	2 parentCharge: short
	...
	14 peakList: peakList: sizeof(TwoValues<float>) * numPeaks, each entry is a TwoValues type
	*/
//	unsigned char* Spectrum::serialize(int& len) {
//
...
//
//		// 0 specID: unsigned long long
//		memcpy(buffer + offset, &specID, sizeof(unsigned long long));
//		offset += sizeof(unsigned long long);
//
//		// 1 scan: int
//		memcpy(buffer + offset, &scan, sizeof(int));
//		offset += sizeof(int);
//
//		// 2 parentCharge: short
//		memcpy(buffer + offset, &parentCharge, sizeof(short));
//		offset += sizeof(short);
//
//		// 7 fileName: int + actual bytes
//		int fileName_size = fileName.size();
//		memcpy(buffer + offset, &fileName_size, sizeof(int));
//		offset += sizeof(int);
//
//		memcpy(buffer + offset, fileName.c_str(), fileName_size);
//		offset += fileName_size;
//
//		// 8 parentMass: float
//		memcpy(buffer + offset, &parentMass, sizeof(float));
//		offset += sizeof(float);
//
//		// 13 numPeaks = peakList.size(): int
//		int numPeaks = peakList.size();
//		memcpy(buffer + offset, &numPeaks, sizeof(int));
//		offset += sizeof(int);
//
//		if (global_intensity_compression == false) {
//			// 14 peakList: sizeof(TwoValues<float>) * numPeaks, each entry is a TwoValues type
//			memcpy(buffer + offset, peakList.data(), sizeof(TwoValues<float>) * numPeaks);
//			offset += (sizeof(TwoValues<float>) * numPeaks);
//		} else {
//			// cout << "...compressed..." << endl;
//			// IDs go first
//			for (int i = 0; i < numPeaks; i ++) {
//				memcpy(buffer + offset, &(peakList[i][0]), sizeof(float));
//				offset += sizeof(float);
//			}
//
//			// intensities afterwards
//			for (int i = 0; i < numPeaks; i ++) {
//				int intensity = (int)(255*peakList[i][1]);
//				unsigned char tmp_intensity = (unsigned char)intensity;
//				memcpy(buffer + offset, &(tmp_intensity), sizeof(unsigned char));
//				offset += sizeof(unsigned char);
//			}
//		}
//
//		if (offset != len) {
//			cout << "Spectrum::serialize() error, offset != len..." << endl;
//			cout << "offset = " << offset << ", len = " << len << endl;
//			exit(0);
//		}
//
//		return buffer;
...
//// #if INTENSITY_COMPRESSION == 0
//		// 14 peakList: sizeof(TwoValues<float>) * numPeaks, each entry is a TwoValues type
//		if (global_intensity_compression == 0)
//			offset += (sizeof(TwoValues<float>) * numPeaks);
//		else {
//			offset += (sizeof(float) * numPeaks);
//			offset += (sizeof(unsigned char) * numPeaks); // intensity is compressed using 1 byte
//		}
//		return offset;
//	}
	...
	* deserialization order
	...
	14 peakList: peakList: sizeof(TwoValues<float>) * numPeaks, each entry is a TwoValues type
	*/
//	Spectrum::Spectrum(unsigned char* bytes, int len) {
//		unsigned char* p = bytes;
//		int offset = 0;
//
//		// 0 specID: unsigned long long
//		specID = *((unsigned long long*) (p + offset));
//		offset += sizeof(unsigned long long);
...
//
//		// 2 parentCharge: short
//		parentCharge = *((short*) (p + offset));
//		offset += sizeof(short);
////        cout << "parentChaerge" << parentCharge << endl;
//
//		// 7 fileName: int + actual bytes
//		int fileName_size = *((int*) (p + offset));
//		offset += sizeof(int);
//		fileName.resize(fileName_size);
//		fileName.replace(0, fileName_size, (char*)(p + offset), fileName_size);
//		offset += fileName_size;
////        cout << "fileName" << fileName << endl;
//
//		// 8 parentMass: float
//		parentMass = *((float*) (p + offset));
//		offset += sizeof(float);
////        cout << "parentMass" << parentMass << endl;
//
//        if (parentCharge > 0) {
//            parentMZ = (parentMass + ((parentCharge - 1.0) * AAJumps::massHion)) / parentCharge;
//        } else {
//            parentMZ = parentMass;
//        }
//
//		// 13 numPeaks = peakList.size(): int
//		int numPeaks = *((int*) (p + offset));
//		offset += sizeof(int);
////        cout << "numPeaks" << numPeaks << endl;
//
//		// 14 peakList: sizeof(TwoValues<float>) * numPeaks, each entry is a TwoValues type
//		peakList.resize(numPeaks);
//    cout << "resized" << endl;
//// #if INTENSITY_COMPRESSION == 0
//		if (global_intensity_compression == 0) {
//      cout << "global compression on" << endl;
//			memcpy(peakList.data(), p + offset, sizeof(TwoValues<float>) * numPeaks);
//			offset += (sizeof(TwoValues<float>) * numPeaks);
//		} else {
//      cout << "global compression off" << endl;
//
//			for (int i = 0; i < numPeaks; i ++) {
//				float i_dim = 0;
//				memcpy(&i_dim, p + offset, sizeof(float));
//				offset += sizeof(float);
//				peakList[i][0] = i_dim;
//			}
//      cout << "set each peak" << endl;
//
//
//			for (int i = 0; i < numPeaks; i ++) {
//				// unsigned char tmp_intensity = (unsigned char)intensity;
//				unsigned char tmp_intensity = 0;
//				memcpy(&tmp_intensity, p + offset, sizeof(unsigned char));
//				offset += sizeof(unsigned char);
//				peakList[i][1] = (float)(tmp_intensity) / 255.0;
//			}
//
//      cout << "uncompress each peak" << endl;
//
//		}
//
//		if (offset != len) {
//			cout << "Spectrum::Spectrum() error, offset != len..." << endl;
//			cout << "offset = " << offset << ", len = " << len << endl;
//			exit(0);
//		}
//	}
	...
	* @csjgwang
	* @param k
	* @return top-k peaks efficiently without sorting
	*/
//	vector<Entry_Int_Float> Spectrum::get_top_k_peaks(int k) {
//		// priority_queue<Entry_Int_Float> min_heap; // by default, it's max heap
//		priority_queue<Entry_Int_Float, vector<Entry_Int_Float>, greater<Entry_Int_Float> > min_heap;
//
//		int num_peaks = peakList.size();
//
//		if (k >= num_peaks)
...
//
//		for (int i = 0; i < k; i ++) {
//			get_kth_peak(i, i_dim, i_value);
//			Entry_Int_Float entry;
//			entry.ID = (int)(i_dim);
//			entry.value = i_value;
//			min_heap.push(entry);
//		}
//
//		for (int i = k; i < num_peaks; i ++) {
//			get_kth_peak(i, i_dim, i_value);
//			Entry_Int_Float entry = min_heap.top();
//			if (i_value > entry.value) {
//				min_heap.pop(); // delete the smallest one
//				entry.ID 	= i_dim;
//				entry.value = i_value;
//				min_heap.push(entry); // push the new one
//			}
//		}
//
//		vector<Entry_Int_Float> result;
//		result.reserve(k);
//		Entry_Int_Float entry;
//		for (int i = 0; i < k; i ++)
...
//	}
	...
	* @csjgwang
	* @param array_form
	* @return an array of of peak intensities, dimension: gloal_max_dimension
	*/
//	void Spectrum::get_spectrum_in_array_form(float* array_form){
//		int i = 0;
//		int num_peaks = peakList.size();
//		int tmp_num_peaks = (num_peaks < TOP_NUM_PEAKS_FOR_QUERY ? num_peaks : TOP_NUM_PEAKS_FOR_QUERY);
//		for (i = 0; i < tmp_num_peaks; i ++) {
//			float data_i_dim = 0;
//			float data_i_value = 0;
//			this->get_kth_peak(i, data_i_dim, data_i_value);
//
//			array_form[(int)(data_i_dim)] = data_i_value;
//		}
//	}

    /**
	* @csjgwang
	* @return the square root of the squared sum of the peaks
	*/
//	float Spectrum::get_L2_norm() {
//		float l2_norm = 0;
//		int num_peaks = peakList.size();
//		for (int i = 0; i < num_peaks; i ++) {
//			float i_dim = 0;
//			float i_value = 0;
//			this->get_kth_peak(i, i_dim, i_value);
//
//			l2_norm += (i_value * i_value);
//		}
//
//		return sqrt(l2_norm);
//	}
    ...
    /**
	* @csjgwang
	* @return print out the full spec
	*/
//	void Spectrum::output_ms3(ostream &output) {
//		output << "BEGIN IONS" 			<< endl;
//		output << "PEPMASS=" 			<< parentMass			<< endl;
//		output << "CHARGE=" 			<< parentCharge			<< endl;
//		output << "FILENAME=" 			<< fileName 			<< endl;
//        output << "SCPECID=" 			<< specID			<< endl;
//		output << "SCANS=" 				<< scan 				<< endl;
////		for (unsigned int i = 0; i < peakList.size(); i++)
////		    output << peakList[i][0] << "\t" << peakList[i][1] << endl;
//		output << "END IONS" << endl;
//	}
